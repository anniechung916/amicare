...
SEED_CARRIERS = [
    {
        ...
        "ivr_navigation": {
            "benefits_verification": "Press 1 (Provider) -> 2 (Eligibility/Benefits) -> wait for rep",
            "claims_status": "Press 1 (Provider) -> 3 (Claims) -> wait for rep",
            "notes": "Provider line: enter NPI when prompted, then member ID. Say 'benefits verification' if voice prompt appears.",
        },
    ...
    },
    {
        ...
        "category": "National",
        "phone_numbers": {
            "provider_services": "1-888-266-6534",
            "customer_service": "1-800-331-1476",
            "oon_benefits_verification": "1-800-331-1476",
            "claims_status": "1-800-331-1476",
        },
        "ivr_navigation": {
            "benefits_verification": "Press 1 (English) -> 2 (Provider/Office) -> 1 (Eligibility & Benefits) -> wait for rep",
            "notes": "Provider line. Enter NPI when prompted, then member ID. May route by ZIP code.",
        },
    ...
    },
    {
        ...
        "ivr_navigation": {
            "benefits_verification": "Press 2 (Provider) -> 1 (Eligibility/Benefits) -> wait for rep",
            "notes": "Provider line. Enter NPI and then member ID when prompted. Sometimes routes by member ID prefix.",
        },
    ...
    },
    {
        ...
        "category": "National",
        "phone_numbers": {
            "provider_services": "1-800-882-4462",
        ...
        "ivr_navigation": {
            ...
            "notes": "Provider line. Enter NPI when prompted. Pre-auth check is often combined with eligibility.",
        },
    ...
    },
    {
        ...
        "category": "Regional",
        "phone_numbers": {
            "provider_services": "1-800-676-2583",
            "customer_service": "See member card - varies by state",
            "oon_benefits_verification": "1-800-810-2583",
            "claims_status": "See member card",
        },
        "ivr_navigation": {
            "benefits_verification": "Press option for Provider Services -> Eligibility & Benefits -> wait for rep",
            "notes": "BCBS is a federation — each state is independent. Provider services number varies by state. National bluecard provider line: 1-800-676-2583.",
        },
    ...
    },
    {
        ...
        "category": "National",
        "phone_numbers": {
            "provider_services": "1-800-457-4708",
            "customer_service": "1-800-448-6262",
            "oon_benefits_verification": "1-800-448-6262",
            "claims_status": "1-800-448-6262",
        },
        "ivr_navigation": {
            "benefits_verification": "Press 1 (Provider) -> 1 (Eligibility & Benefits) -> wait for rep",
            "notes": "Provider line. Enter NPI, then member ID. May ask for member ID via IVR. Confirm commercial vs Medicare Advantage upfront.",
        },
    ...
    },
    {
        ...
        "phone_numbers": {
            "provider_services": "1-800-464-4000",
            "customer_service": "1-800-464-4000",
            "oon_benefits_verification": "1-800-464-4000",
        },
        "ivr_navigation": {
            "benefits_verification": "Press 3 (Provider) -> say 'benefits' or press option for eligibility -> wait for rep",
            "notes": "Kaiser provider line varies by region (NorCal, SoCal, NW, Mid-Atlantic). HMO — OON coverage extremely limited. Always confirm if emergency or authorized exception.",
        },
    ...
    },
    {
        ...
        "category": "Regional",
        "phone_numbers": {
            "provider_services": "1-800-666-1353",
            "customer_service": "1-800-444-6222",
            "oon_benefits_verification": "1-800-444-6222",
        },
        "ivr_navigation": {
            "benefits_verification": "Press 1 (Provider) -> 2 (Eligibility & Benefits) -> wait for rep",
            "notes": "UHC subsidiary. Provider line routes to UHC provider services. Enter NPI, then member ID. Confirm Oxford EPO vs PPO plan type first.",
        },
        "required_info": ["Member ID", "Date of Birth", "Group Number"],
        "avg_hold_time_minutes": 18,
